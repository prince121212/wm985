# Privacy Policy for 文明知识库

## Introduction

Welcome to 文明知识库 (Civilization Knowledge Base), the **resource sharing platform** designed to help you discover, share and download various civilization-related resources. At 文明知识库, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using 文明知识库:
...
2. **Usage Details**
   ...
   - **What We Collect**: Information about how you use 文明知识库, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**

   - **What We Collect**: Data regarding the devices you use to access 文明知识库, such as device type, operating system, and browser type.
...
By using 文明知识库, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
