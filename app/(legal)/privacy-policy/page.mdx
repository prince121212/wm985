# Privacy Policy for 文明资源站

## Introduction

Welcome to 文明资源站 (Civilization Resources Platform), the **resource sharing platform** designed to help you discover, share and download various civilization-related resources. At 文明资源站, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using 文明资源站:
...
2. **Usage Details**
   ...
   - **What We Collect**: Information about how you use 文明资源站, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**

   - **What We Collect**: Data regarding the devices you use to access 文明资源站, such as device type, operating system, and browser type.
...
**Copyright Owner**: [wm985.com](http://wm985.com)
**Email**: [support@wm985.com](mailto:support@wm985.com)

By using 文明资源站, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
